<template>
  <div>
    <div v-if="showMe">
      ...
      <div class="order_box">
        <!-- //遍历同时创建a链接
        <div v-for=" (item, index) in getFalseOrder" :key=getFalseOrder[item]  v-on:click="onclick($index)" href="#" class="order_one"> -->
        <div v-for="item in getFalseOrder" :key=getFalseOrder[item] class="order_one">
          <div class="order_img">
